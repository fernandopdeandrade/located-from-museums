...
Para que o projeto possa compilar, precisamos implementar as classes de Modelo e DTOs.
...
<details>
  <summary>Crie uma classe chamada GeneralControllerAdvice dentro do pacote `com.betrybe.museumfinder.advice`. Use a anotação ControllerAdvice para especificar que esta classe é responsável por tratar as exceções e gerar respostas</summary><br />
